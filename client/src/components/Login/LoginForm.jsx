  ...
  return (
    <>
      <div className="flex min-h-screen justify-center items-center px-6 py-12 lg:px-8">
        <div className="flex flex-col lg:flex-row lg:gap-20 lg:justify-center lg:items-center lg:p-20 lg:rounded-lg bg-white rounded-md shadow-lg h-fit py-10 px-10">
          <div>
            <img className="mx-auto h-20" src={Logo} alt="Your Company" />
